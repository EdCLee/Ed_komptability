...
class DataCenter {
    ...
    private let fileManager:FileManager = FileManager.init()
    private let docPath:String = NSSearchPathForDirectoriesInDomains(FileManager.SearchPathDirectory.documentDirectory, .userDomainMask, true).last! + "/Person.plist"
    ...
    /// add new person!
//    func add(personWithDictionary dict:[String:Any]) {
...
//    }
    ...
    func remove(person: Person) {
        self.rawArray.remove(at: self.rawArray.index(of: person)!)
        self.saveToDoc()
    }
